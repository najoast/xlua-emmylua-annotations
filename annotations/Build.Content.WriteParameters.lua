---@class Build.Content.WriteParameters @This struct collects all the WriteSerializedFile parameters in to a single place.
...
---@field bundleInfo fun() @Optional Parameter used when writing a serialized file for an Asset Bundle.
...
---@field preloadInfo fun() @The set of external object dependencies that need to be loaded when loading the resulting serialized file.
